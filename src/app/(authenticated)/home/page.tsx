          ...
          <Card key={index}>
            ...
            <CardContent className="h-[300px] flex items-center justify-center">
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={formatChartData(dashboard?.[title === 'Visitas por Data' ? 'count_views_per_date' : title === 'Origem do Tráfego' ? 'traffic_origin' : title === 'Localização' ? 'locations' : 'devices'] || {})}>
