...
const MobileScreen: React.FC<MobileScreenProps> = ({ bioData }) => {
  ...
  return (
    <div className="lg:max-w-[90%] w-full lg:flex lg:justify-around rounded-xl">
      <Card className="relative min-w-full min-h-screen  rounded-xl pb-10 overflow-hidden border-0" style={{
      ...
      <div className="p-4 gap-5 max-w-xl lg:flex items-start justify-center mx-auto lg:mx-0 lg:max-w-[100%] h-full">
